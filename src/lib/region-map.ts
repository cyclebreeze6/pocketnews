/**
 * Mapping of countries to continents for grouping.
 */
export const CONTINENTS = ["Africa", "Asia", "Europe", "North America", "South America", "Oceania"];

export const COUNTRY_TO_CONTINENT: { [key: string]: string } = {
  // Africa
  ...
  "Congo, Republic of the": "Africa", "Cote d'Ivoire": "Africa", "Djibouti": "Africa", "Egypt": "Africa", 
  ...
  "Philippines": "Asia", "Qatar": "Asia", "Russia": "Asia", "Saudi Arabia": "Asia", "Singapore": "Asia", 
